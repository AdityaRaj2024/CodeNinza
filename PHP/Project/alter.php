<?php
						...
						{
							$dl = $_GET['dl'];
							$query1 = "SELECT * FROM data where id = '$dl'";
							...
							if(isset($_POST['n_ame']))
							{
								...
								{
									$name=$_POST['name'];
									$query = "UPDATE data SET name = '$name' WHERE id = '$dl'; ";
							...
							elseif(isset($_POST['i_d']))
							{
								...
								{
									$id=$_POST['id'];
									$query = "UPDATE data SET id = '$id' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_1']))
							{
								if(!empty($_POST['s1']))
								{
									...
									$query = "UPDATE data SET s1 = '$s1',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_2']))
							{
								if(!empty($_POST['s2']))
								{
									...
									$query = "UPDATE data SET s2 = '$s2',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_3']))
							{
								if(!empty($_POST['s3']))
								{
									...
									$query = "UPDATE data SET s3 = '$s3',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_4']))
							{
								if(!empty($_POST['s4']))
								{
									...
									$query = "UPDATE data SET s4 = '$s4',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_5']))
							{
								if(!empty($_POST['s5']))
								{
									...
									$query = "UPDATE data SET s5 = '$s5',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
							elseif(isset($_POST['s_6']))
							{
								if(!empty($_POST['s6']))
								{
									...
									$query = "UPDATE data SET s6 = '$s6',CGPA = '$cgpa' WHERE id = '$dl'; ";
									$rs=mysqli_query($conn,$query);
									$ans="Record is updated";
								}
							}
